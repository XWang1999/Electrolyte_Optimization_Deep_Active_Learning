...
from .utils import grad_check,calc_acc,one_hot,check_random_state
...
class NNRegressor(CoreNN):
	...
	def predict(self,X):
		...
		return preds, numpy.sqrt(numpy.diagonal(K2-numpy.dot(K3,numpy.dot(self.K_inv,K3.T)))), K2 - numpy.dot(K3, numpy.dot(self.K_inv, K3.T))
